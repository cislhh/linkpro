 ...
 * Requirements: 12.2
 */
export function ModuleCard({ module, links, isEditing = false, className }: ModuleCardProps) {
    ...
    return (
        ...
        >
            ...
            <div className="h-full overflow-hidden">
                <ModuleContent module={module} links={links} isPreview />
            </div>
        </div>
    );
}
 ...
 */
function ModuleContent({ module, links, isPreview = false }: ModuleContentProps) {
    switch (module.type) {
        case "links":
            return <LinksModule module={module} links={links} isPreview={isPreview} />;
        case "bio":
            return <BioModule module={module} />;
        case "skills":
